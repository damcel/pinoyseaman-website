...
<body>
    <div class="page-wrapper">
        ...
        <main>
            ...
            <section class="contact-ctn">
                    ...
                    <form action="includes/forgotPass_seaman_verify.php" method="POST">
    ...
    <div id="otpModal" class="modal" style="display:none;">
        <div class="modal-content" style="max-width:400px;margin:auto;padding:30px;border-radius:8px;background:#fff;box-shadow:0 2px 8px rgba(0,0,0,0.2);">
            ...
            <form id="otpForm" action="includes/verify_otp.php" method="POST">
    ...
    <script>
        ...
        document.querySelector('form[action="includes/forgotPass_seaman_verify.php"]').addEventListener('submit', function(e) {
    ...
    <script>
        ...
        function fetchOtpExpiryAndStartTimer(email) {
            fetch('includes/ajax_get_otp_expiry.php', {
                method: 'POST',
