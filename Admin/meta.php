<meta name="description" content="seaman jobs, maritime jobs">
...
.red { font-size:small; color: #FF0000;}
...
.style17 { font-size:small; color: #FF0000;}
.style1 { font-size:small; color: #FF0000;}
.style2 {font-size: medium; font-weight: bold; color: #000000;}
.style4 {color: #000000}
.error { font-size: small; color: #FF0000;}
.style5 { font-size: 12px; font-family: Arial, Helvetica, sans-serif; color: #FF0000;}
-->
</style>
...
/*
  var x=document.forms["register_seaman"]["language"].value;
if (x==null || x=="")
  {
  alert("Language / Dialects is required!");
  return false;
  }
*/
/*
  var x=document.forms["register_seaman"]["educ_training"].value;
if (x==null || x=="")
  {
  alert("Education / Training is required!");
  return false;
  }
*/
