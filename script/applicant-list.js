document.addEventListener('DOMContentLoaded', function () {
    ...
    document.getElementById('searchApplicantsBtn').addEventListener('click', fetchApplicants);

    // Automatically call AJAX on page load for default select job
    fetchApplicants();
        ...
        if (btn) {
            ...
            if (applicantId) {
                ...
                fetch('includes/mark_applicant_viewed.php', {
                    ...
                    body: 'id=' + encodeURIComponent(applicantId) +
